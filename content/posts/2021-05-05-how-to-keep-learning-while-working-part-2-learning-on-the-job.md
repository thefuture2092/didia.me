...
This packed schedule pretty much explains why I couldn't find time to learn outside of work on weekdays. Before having a family, I could spend time after work to work on a side project to learn a new technique. But now, it was impossible to do so because that time was now reserved for my family. So the only possibility for me was learning on weekends, right ?

Wrong! Well, when it came to weekends, I had another big challenge. When we first started living together, my wife became bordered that I was spending as much time working on weekdays than on weekends and she let me know about it. Since then, I have tried to make sure my weekends are as light on work as possible. On Saturday, I can spend up to three hours working on RDC Études and I try to do it either early in the morning while my son is still sleeping or in the afternoon while he is having his nap. But on Sunday, working is down right prohibited. I don't do anything remotely related to work unless I am on-call that week. Sunday is really off-limit.
...
This meant that I needed to use my project time in order to keep learning which I wasn't very confortable with because it meant using project time on something that may not even be useful for my client or company. And even if I were confortable doing it, It would be hard to pull off because I couldn't afford downtime on the project I was working on.
